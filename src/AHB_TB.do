...
# Sivan
add wave -noupdate -expand -group Manager_Cable /AHB_TB/d0/mast_mmgr/*
add wave -noupdate -expand -group Subordinate_Cable /AHB_TB/d0/mmgr_sub/*
add wave -noupdate -expand -group AHB_MMgr /AHB_TB/d0/my_mmgr/*
add wave -noupdate -expand -group Subordinate_signals /AHB_TB/d0/so/*
add wave -noupdate -expand -group Master_0_outputs /AHB_TB/d0/mo/i_start
delete wave /*/*/*/HPROT
